...
public class P02_FlexibleNavigation {
    ...
    public void task1() throws SQLException {
        ...
        /*
        ResultSet.TYPE_SCROLL_INSENSITIVE --> to be able to scroll your cursor dynamically and jump to specific rows
                                              we are going to use that as a parameter into createStatement
